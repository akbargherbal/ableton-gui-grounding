...
### Screenshot orchestration design (sessions 5–6 FINALIZED; session 9 plan written; session 10 Phase 0 COMPLETED)
...
2. **Phase 1. STATUS: Next up (Phase 0 complete).** Ship
   `orchestrate.sh` (new file, repo root) for single-action tasks:
...
3. **Phase 2. STATUS: Pending Phase 1.** For `solo_tour`, apply Option A:
