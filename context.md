...
**Not yet done:** applying this table to this project's actual confirmed
`automation_id` scheme (Solo/Mute/Arm/Tempo/Slot) against real, not
hypothetical, UI layouts.
